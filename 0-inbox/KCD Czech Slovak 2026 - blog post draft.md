...
### [Keynote: Rethinking Observability as a Platform Product](https://kcd-czech-slovak-2026.sessionize.com/session/1204850) — [Kasper Borg Nissen](https://www.linkedin.com/in/kaspernissen)
...
### [We Built an AI Incident Responder. Here's What We Got Wrong.](https://kcd-czech-slovak-2026.sessionize.com/session/1196794) — [David Pech](https://www.linkedin.com/in/david-pech)
...
### [Hundreds of Environments, Database Resets at Scale with Argo](https://kcd-czech-slovak-2026.sessionize.com/session/1192018) — [Martin Beránek](https://www.linkedin.com/in/martin-ber%C3%A1nek/)
...
### [Treating Kubernetes as a Linux Distro: APT-Style Packaging with FluxCD](https://kcd-czech-slovak-2026.sessionize.com/session/1169068) — [Andrei Kvapil](https://www.linkedin.com/in/kvaps)
...
### [The OS Layer Your Platform Ignores](https://kcd-czech-slovak-2026.sessionize.com/session/1197215) — [Brian Exelbierd](https://www.linkedin.com/in/bexelbie)
...
Brian (Microsoft) made the case for immutable operating systems — specifically [Flatcar](https://www.flatcar.org/) — where the OS itself becomes a read-only artifact and drift becomes structurally impossible rather than just detectable. The [Kubernetes Shift Down Security Paper](https://github.com/kubernetes/sig-security/blob/main/sig-security-docs/papers/shift-down/shift-down-security.md) was recommended reading. I'm thinking to try Flatcar as OS for my Kubernetes worker nodes (currently on server Ubuntu updated manually via `apt upgrade`, which makes the nodes drift). [Talos](https://www.talos.dev/) is a similar tool I've been keeping an eye on independently.

### [Kubernetes-in-Kubernetes: Hosted Control Planes](https://kcd-czech-slovak-2026.sessionize.com/session/1195818) — [Ashley Reese](https://www.linkedin.com/in/ashley-reese-a6461737)
...
### [Craft Your Home AI Lab with Ollama + Open WebUI](https://kcd-czech-slovak-2026.sessionize.com/session/1193106) — [Petr Hanák](https://www.linkedin.com/in/petrhanak)
...
### [GitOps using ArgoCD and Kargo](https://kcd-czech-slovak-2026.sessionize.com/session/1228884) — [Ondrej Sika](https://www.linkedin.com/in/ondrejsika/)

A hands-on workshop building a complete GitOps delivery pipeline from scratch: ArgoCD for cluster sync, [Kargo](https://kargo.io/) for multi-stage environment promotion (dev → stage → prod). The distinction matters — ArgoCD keeps a cluster in sync with git, but it doesn't decide *when* to promote a change to the next environment. That's Kargo's job, and it turns out to be a much cleaner solution than custom CI pipeline scripts or ArgoCD Image Updater hacks. Workshop materials are at [github.com/ondrejsika/kcd2026-kargo-workshop](https://github.com/ondrejsika/kcd2026-kargo-workshop).
...
### [State of Kubernetes on European Sovereign Clouds](https://kcd-czech-slovak-2026.sessionize.com/session/1145752) — [Kim Sondrup](https://www.linkedin.com/in/kimsondrup/)
...
### [The Complete Guide to Secret Hygiene for Java and Cloud-Native Engineers](https://kcd-czech-slovak-2026.sessionize.com/session/1195757) — [Martin Ladecký](https://www.linkedin.com/in/martin-ladeck%C3%BD-9366ba5/)

Probably the most forensically satisfying talk of the conference. Martin structured it around an "evidence chain" — every stage where secrets can and do escape: the developer's desk (`settings.xml`), source control (Git history), container images (Docker layers), pipelines (log output), and runtime (Vault/secret stores). Demo code is at [github.com/martin-ladecky/kcd-cz-sk-2026](https://github.com/martin-ladecky/kcd-cz-sk-2026).
...
This one was immediately actionable — I encrypted my own Maven `settings.xml` passwords right after the talk.

### [System Design in Your Hands](https://kcd-czech-slovak-2026.sessionize.com/session/1135302) — [Emrah Sifoğlu](https://www.linkedin.com/in/emrahsifoglu/)
...
### [Breaking Free of a Single Datacenter: Geo-Distributed AI Platforms with k0smos](https://kcd-czech-slovak-2026.sessionize.com/session/1196748) — [Jussi Nummelin](https://linkedin.com/in/jnummelin/) & [Soeren Becker](https://www.linkedin.com/in/soeren-becker-9978611bb/)
